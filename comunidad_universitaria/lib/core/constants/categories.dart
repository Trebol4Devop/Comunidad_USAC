...
class USACConstants {
  ...
  static const List<ForumCategory> forumCategories = [
    ...
    ForumCategory(
      ...
      description:
          'Dudas sobre créditos, prerrequisitos, equivalencias y cierres de pensum.',
    ),
    ForumCategory(
      id: 'catedraticos',
      label: 'Catedráticos & Auxiliares',
      description:
          'Experiencias, metodología de enseñanza y recomendaciones de catedráticos.',
    ),
    ForumCategory(
      id: 'horarios',
      label: 'Horarios & Secciones',
      description:
          'Información sobre traslapes, asignaciones de secciones y laboratorios.',
    ),
    ForumCategory(
      id: 'apuntes',
  ...
  static const List<MarketplaceCategoryOption> marketplaceCategories = [
    MarketplaceCategoryOption(
      ...
      iconName: 'storefront',
      description:
          'Explora todos los productos, comidas, tutorías y materiales.',
    ),
    MarketplaceCategoryOption(
      id: 'comida_postres',
    ...
    MarketplaceCategoryOption(
      ...
      iconName: 'menu_book',
      description:
          'Libros de texto, batas, calculadoras, instrumental médico, odontológico o dibujo.',
    ),
    MarketplaceCategoryOption(
      ...
      description:
          'Impresiones, empastados, desarrollo de software, diseño gráfico y asesoría técnica.',
    ),
    MarketplaceCategoryOption(
      id: 'otros_articulos',
      ...
      description:
          'Accesorios, tecnología, ropa y artículos varios de segunda mano o nuevos.',
    ),
  ];
  ...
  static const List<Map<String, String>> sedes = [
    {
      'id': 'todas',
      'nombre': 'Todas las Sedes / General',
    ...
    {
      'id': 'cunor',
      'nombre': 'CUNOR - Cobán, Alta Verapaz',
      'departamento': 'Alta Verapaz',
    },
    {
      'id': 'cuchim',
      'nombre': 'Sede Chimaltenango',
      'departamento': 'Chimaltenango',
    },
    {'id': 'cuesc', 'nombre': 'Sede Escuintla', 'departamento': 'Escuintla'},
    {
      'id': 'cunoroc',
      'nombre': 'CUNOROC - Huehuetenango',
      'departamento': 'Huehuetenango',
    },
    {
      'id': 'cunori',
      'nombre': 'CUNORI - Chiquimula',
      'departamento': 'Chiquimula',
    },
    {
      'id': 'cunizab',
      'nombre': 'CUNIZAB - Puerto Barrios / Izabal',
      'departamento': 'Izabal',
    },
    {
      'id': 'cusam',
    ...
    {
      'id': 'cunsuroc',
      'nombre': 'CUNSUROC - Mazatenango / Suchitepéquez',
    ...
    {
      'id': 'metropolitana_mixco',
      'nombre': 'Sede Mixco',
      'departamento': 'Guatemala',
    },
    {
      'id': 'metropolitana_villanueva',
      'nombre': 'Sede Villa Nueva',
      'departamento': 'Guatemala',
    },
    {
      'id': 'metropolitana_amatitlan',
      'nombre': 'Sede Amatitlán',
      'departamento': 'Guatemala',
    },
    {
      'id': 'metropolitana_pinula',
      'nombre': 'Sede San José Pinula',
      'departamento': 'Guatemala',
    },
  ];
  ...
  static const List<Map<String, dynamic>> campusBuildings = [
    ...
    },
    {
      ...
      'longitude': null,
      'description':
          'Entrega coordinada dentro de las instalaciones de la sede.',
    },
  ];
  ...
  static const List<Map<String, dynamic>> facultades = [
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Agronomía',
          'codigo': '01-00-00',
          'sede': 'Campus Central',
          'modalidades': ['Diario'],
        },
        {
          'id': '01-00-02',
          'nombre': 'Ingeniería Agronómica en Sistemas de Producción Agrícola',
          'codigo': '01-00-02',
          'sede': 'Campus Central',
          'modalidades': ['Diario', 'Sabatino', 'Dominical'],
        },
        {
          'id': '01-00-03',
          'nombre': 'Ingeniería Agronómica en Recursos Naturales Renovables',
          'codigo': '01-00-03',
          'sede': 'Campus Central',
          'modalidades': ['Diario', 'Sabatino', 'Dominical'],
        },
        {
          'id': '01-00-04',
          'nombre': 'Ingeniería en Industrias Agropecuarias y Forestales',
          'codigo': '01-00-04',
          'sede': 'Campus Central',
        ...
        {
          'id': '01-00-07',
          'nombre': 'Ingeniería en Gestión Ambiental Local',
          'codigo': '01-00-07',
          'sede': 'Campus Central',
          'modalidades': ['Diario', 'Sabatino', 'Dominical'],
        },
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Arquitectura',
          'codigo': '02-00-00',
          'sede': 'Campus Central',
          'modalidades': ['Diario'],
        },
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Económicas',
          'codigo': '03-00-00',
          'sede': 'Campus Central',
          'modalidades': ['Diario'],
        },
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Derecho',
          'codigo': '04-00-00',
          'sede': 'Campus Central',
          'modalidades': ['Diario'],
        },
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Medicina y Salud',
          'codigo': '05-00-00',
          'sede': 'CUM, Zona 11',
          'modalidades': ['Diario'],
        },
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Farmacia y Química',
          'codigo': '06-00-00',
          'sede': 'Campus Central',
          'modalidades': ['Diario'],
        },
        ...
        {
          'id': '06-00-02',
          'nombre': 'Licenciatura en Química Biológica',
          'codigo': '06-00-02',
          'sede': 'Campus Central',
          'modalidades': ['Diario', 'Sabatino', 'Dominical'],
        },
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Humanidades',
          'codigo': '77-00-00',
          'sede': 'Campus Central / Extensiones',
          'modalidades': ['Diario', 'Sabatino', 'Dominical'],
        },
        {
          'id': '77-00-55',
          'nombre': 'PEM en Pedagogía y Técnico en Administración Educativa',
          'codigo': '77-00-55',
          'sede': 'Central & Sedes Departamentales',
          'modalidades': ['Diario', 'Sabatino', 'Dominical'],
        },
        {
          'id': '77-00-18',
          'nombre': 'PEM en Pedagogía, Promotor de DDHH y Cultura de Paz',
          'codigo': '77-00-18',
          'sede': 'Central & Sedes Departamentales',
          'modalidades': ['Diario', 'Sabatino', 'Dominical'],
        },
        {
          'id': '77-00-28',
          'nombre': 'PEM en Pedagogía, Ciencias Sociales y Formación Ciudadana',
          'codigo': '77-00-28',
          'sede': 'Central & Sedes Departamentales',
          'modalidades': ['Diario', 'Sabatino', 'Dominical'],
        },
        {
          'id': '77-00-23',
          'nombre': 'PEM en Idioma Inglés',
          'codigo': '77-00-23',
          'sede': 'Central, Antigua, Quetzaltenango',
          'modalidades': ['Diario', 'Sabatino'],
        },
        {
          'id': '77-00-78',
          ...
          'codigo': '77-00-78',
          'sede': 'Central & Sedes Departamentales',
          'modalidades': ['Sabatino', 'Dominical'],
        },
        {
          'id': '77-00-17',
          'nombre': 'PEM en Ciencias Económico Contables',
          'codigo': '77-00-17',
          'sede': 'Central & Sedes Departamentales',
          'modalidades': ['Sabatino', 'Dominical'],
        },
        {
          'id': '77-00-74',
          'nombre': 'PEM en Pedagogía y Educación Intercultural',
          'codigo': '77-00-74',
          'sede': 'Sedes Departamentales',
          'modalidades': ['Sabatino', 'Dominical'],
        },
        {
          'id': '77-00-26',
          'nombre': 'PEM en Artes Plásticas e Historia del Arte',
          'codigo': '77-00-26',
          'sede': 'Campus Central',
          'modalidades': ['Diario', 'Sabatino'],
        },
        {
          'id': '77-00-27',
          'nombre': 'PEM en Educación Musical',
          'codigo': '77-00-27',
          'sede': 'Campus Central',
          'modalidades': ['Diario', 'Sabatino'],
        },
        ...
        {
          'id': '77-00-67',
          'nombre': 'PEM en Pedagogía y Técnico en Investigación Educativa',
          'codigo': '77-00-67',
          'sede': 'Jalapa, Morales, Yupiltepeque',
          'modalidades': ['Sabatino'],
        },
      ],
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Ingeniería',
          'codigo': '08-00-00',
          'sede': 'Campus Central',
          'modalidades': ['Diario'],
        },
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Odontología',
          'codigo': '09-00-00',
          'sede': 'Campus Central',
          'modalidades': ['Diario'],
        },
    ...
    },
    {
      ...
      'carreras': [
        {
          'id': 'todas',
          'nombre': 'Todas las Carreras de Veterinaria',
          'codigo': '10-00-00',
          'sede': 'Campus Central',
          'modalidades': ['Diario'],
        },
